...
class Juego {
  ...
  toggleBtnEmpezar() {
    if (btnEmpezar.classList.contain('hide')){
  ...
  siguienteNivel(){
    this.subnivel = 0
    //this.nombreAtributo = 'valor', de este manera agregamos atributos
  ...
  agregarEventosClick(){
    this.colores.celeste.addEventListener('click', this.elegirColor) //.bind(this)Ata al this de la pantalla
